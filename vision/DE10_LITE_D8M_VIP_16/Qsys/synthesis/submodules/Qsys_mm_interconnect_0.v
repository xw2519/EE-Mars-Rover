...
module Qsys_mm_interconnect_0 (
		...
		output wire [2:0]  control_uart_s1_address,                                    //                                      control_uart_s1.address
		output wire        control_uart_s1_write,                                      //                                                     .write
		output wire        control_uart_s1_read,                                       //                                                     .read
		input  wire [15:0] control_uart_s1_readdata,                                   //                                                     .readdata
		output wire [15:0] control_uart_s1_writedata,                                  //                                                     .writedata
		output wire        control_uart_s1_begintransfer,                              //                                                     .begintransfer
		output wire        control_uart_s1_chipselect,                                 //                                                     .chipselect
	...
	wire  [31:0] control_uart_s1_agent_m0_readdata;                                                // control_uart_s1_translator:uav_readdata -> control_uart_s1_agent:m0_readdata
	wire         control_uart_s1_agent_m0_waitrequest;                                             // control_uart_s1_translator:uav_waitrequest -> control_uart_s1_agent:m0_waitrequest
	wire         control_uart_s1_agent_m0_debugaccess;                                             // control_uart_s1_agent:m0_debugaccess -> control_uart_s1_translator:uav_debugaccess
	wire  [18:0] control_uart_s1_agent_m0_address;                                                 // control_uart_s1_agent:m0_address -> control_uart_s1_translator:uav_address
	wire   [3:0] control_uart_s1_agent_m0_byteenable;                                              // control_uart_s1_agent:m0_byteenable -> control_uart_s1_translator:uav_byteenable
	wire         control_uart_s1_agent_m0_read;                                                    // control_uart_s1_agent:m0_read -> control_uart_s1_translator:uav_read
	wire         control_uart_s1_agent_m0_readdatavalid;                                           // control_uart_s1_translator:uav_readdatavalid -> control_uart_s1_agent:m0_readdatavalid
	wire         control_uart_s1_agent_m0_lock;                                                    // control_uart_s1_agent:m0_lock -> control_uart_s1_translator:uav_lock
	wire  [31:0] control_uart_s1_agent_m0_writedata;                                               // control_uart_s1_agent:m0_writedata -> control_uart_s1_translator:uav_writedata
	wire         control_uart_s1_agent_m0_write;                                                   // control_uart_s1_agent:m0_write -> control_uart_s1_translator:uav_write
	wire   [2:0] control_uart_s1_agent_m0_burstcount;                                              // control_uart_s1_agent:m0_burstcount -> control_uart_s1_translator:uav_burstcount
	wire         control_uart_s1_agent_rf_source_valid;                                            // control_uart_s1_agent:rf_source_valid -> control_uart_s1_agent_rsp_fifo:in_valid
	wire  [97:0] control_uart_s1_agent_rf_source_data;                                             // control_uart_s1_agent:rf_source_data -> control_uart_s1_agent_rsp_fifo:in_data
	wire         control_uart_s1_agent_rf_source_ready;                                            // control_uart_s1_agent_rsp_fifo:in_ready -> control_uart_s1_agent:rf_source_ready
	wire         control_uart_s1_agent_rf_source_startofpacket;                                    // control_uart_s1_agent:rf_source_startofpacket -> control_uart_s1_agent_rsp_fifo:in_startofpacket
	wire         control_uart_s1_agent_rf_source_endofpacket;                                      // control_uart_s1_agent:rf_source_endofpacket -> control_uart_s1_agent_rsp_fifo:in_endofpacket
	wire         control_uart_s1_agent_rsp_fifo_out_valid;                                         // control_uart_s1_agent_rsp_fifo:out_valid -> control_uart_s1_agent:rf_sink_valid
	wire  [97:0] control_uart_s1_agent_rsp_fifo_out_data;                                          // control_uart_s1_agent_rsp_fifo:out_data -> control_uart_s1_agent:rf_sink_data
	wire         control_uart_s1_agent_rsp_fifo_out_ready;                                         // control_uart_s1_agent:rf_sink_ready -> control_uart_s1_agent_rsp_fifo:out_ready
	wire         control_uart_s1_agent_rsp_fifo_out_startofpacket;                                 // control_uart_s1_agent_rsp_fifo:out_startofpacket -> control_uart_s1_agent:rf_sink_startofpacket
	wire         control_uart_s1_agent_rsp_fifo_out_endofpacket;                                   // control_uart_s1_agent_rsp_fifo:out_endofpacket -> control_uart_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_015_src_valid;                                                            // cmd_mux_015:src_valid -> control_uart_s1_agent:cp_valid
	wire  [96:0] cmd_mux_015_src_data;                                                             // cmd_mux_015:src_data -> control_uart_s1_agent:cp_data
	wire         cmd_mux_015_src_ready;                                                            // control_uart_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire  [15:0] cmd_mux_015_src_channel;                                                          // cmd_mux_015:src_channel -> control_uart_s1_agent:cp_channel
	wire         cmd_mux_015_src_startofpacket;                                                    // cmd_mux_015:src_startofpacket -> control_uart_s1_agent:cp_startofpacket
	wire         cmd_mux_015_src_endofpacket;                                                      // cmd_mux_015:src_endofpacket -> control_uart_s1_agent:cp_endofpacket
	...
	wire         control_uart_s1_agent_rp_valid;                                                   // control_uart_s1_agent:rp_valid -> router_017:sink_valid
	wire  [96:0] control_uart_s1_agent_rp_data;                                                    // control_uart_s1_agent:rp_data -> router_017:sink_data
	wire         control_uart_s1_agent_rp_ready;                                                   // router_017:sink_ready -> control_uart_s1_agent:rp_ready
	wire         control_uart_s1_agent_rp_startofpacket;                                           // control_uart_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire         control_uart_s1_agent_rp_endofpacket;                                             // control_uart_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire         control_uart_s1_agent_rdata_fifo_src_valid;                                       // control_uart_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire  [33:0] control_uart_s1_agent_rdata_fifo_src_data;                                        // control_uart_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire         control_uart_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_015:in_0_ready -> control_uart_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_015_out_0_valid;                                                // avalon_st_adapter_015:out_0_valid -> control_uart_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_015_out_0_data;                                                 // avalon_st_adapter_015:out_0_data -> control_uart_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_015_out_0_ready;                                                // control_uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire   [0:0] avalon_st_adapter_015_out_0_error;                                                // avalon_st_adapter_015:out_0_error -> control_uart_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) control_uart_s1_translator (
		.clk                    (clk_50_clk_clk),                                             //                      clk.clk
		.reset                  (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (control_uart_s1_agent_m0_address),                           // avalon_universal_slave_0.address
		.uav_burstcount         (control_uart_s1_agent_m0_burstcount),                        //                         .burstcount
		.uav_read               (control_uart_s1_agent_m0_read),                              //                         .read
		.uav_write              (control_uart_s1_agent_m0_write),                             //                         .write
		.uav_waitrequest        (control_uart_s1_agent_m0_waitrequest),                       //                         .waitrequest
		.uav_readdatavalid      (control_uart_s1_agent_m0_readdatavalid),                     //                         .readdatavalid
		.uav_byteenable         (control_uart_s1_agent_m0_byteenable),                        //                         .byteenable
		.uav_readdata           (control_uart_s1_agent_m0_readdata),                          //                         .readdata
		.uav_writedata          (control_uart_s1_agent_m0_writedata),                         //                         .writedata
		.uav_lock               (control_uart_s1_agent_m0_lock),                              //                         .lock
		.uav_debugaccess        (control_uart_s1_agent_m0_debugaccess),                       //                         .debugaccess
		.av_address             (control_uart_s1_address),                                    //      avalon_anti_slave_0.address
		.av_write               (control_uart_s1_write),                                      //                         .write
		.av_read                (control_uart_s1_read),                                       //                         .read
		.av_readdata            (control_uart_s1_readdata),                                   //                         .readdata
		.av_writedata           (control_uart_s1_writedata),                                  //                         .writedata
		.av_begintransfer       (control_uart_s1_begintransfer),                              //                         .begintransfer
		.av_chipselect          (control_uart_s1_chipselect),                                 //                         .chipselect
		.av_beginbursttransfer  (),                                                           //              (terminated)
		.av_burstcount          (),                                                           //              (terminated)
		.av_byteenable          (),                                                           //              (terminated)
		.av_readdatavalid       (1'b0),                                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) control_uart_s1_agent (
		.clk                     (clk_50_clk_clk),                                             //             clk.clk
		.reset                   (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (control_uart_s1_agent_m0_address),                           //              m0.address
		.m0_burstcount           (control_uart_s1_agent_m0_burstcount),                        //                .burstcount
		.m0_byteenable           (control_uart_s1_agent_m0_byteenable),                        //                .byteenable
		.m0_debugaccess          (control_uart_s1_agent_m0_debugaccess),                       //                .debugaccess
		.m0_lock                 (control_uart_s1_agent_m0_lock),                              //                .lock
		.m0_readdata             (control_uart_s1_agent_m0_readdata),                          //                .readdata
		.m0_readdatavalid        (control_uart_s1_agent_m0_readdatavalid),                     //                .readdatavalid
		.m0_read                 (control_uart_s1_agent_m0_read),                              //                .read
		.m0_waitrequest          (control_uart_s1_agent_m0_waitrequest),                       //                .waitrequest
		.m0_writedata            (control_uart_s1_agent_m0_writedata),                         //                .writedata
		.m0_write                (control_uart_s1_agent_m0_write),                             //                .write
		.rp_endofpacket          (control_uart_s1_agent_rp_endofpacket),                       //              rp.endofpacket
		.rp_ready                (control_uart_s1_agent_rp_ready),                             //                .ready
		.rp_valid                (control_uart_s1_agent_rp_valid),                             //                .valid
		.rp_data                 (control_uart_s1_agent_rp_data),                              //                .data
		.rp_startofpacket        (control_uart_s1_agent_rp_startofpacket),                     //                .startofpacket
		...
		.rf_sink_ready           (control_uart_s1_agent_rsp_fifo_out_ready),                   //         rf_sink.ready
		.rf_sink_valid           (control_uart_s1_agent_rsp_fifo_out_valid),                   //                .valid
		.rf_sink_startofpacket   (control_uart_s1_agent_rsp_fifo_out_startofpacket),           //                .startofpacket
		.rf_sink_endofpacket     (control_uart_s1_agent_rsp_fifo_out_endofpacket),             //                .endofpacket
		.rf_sink_data            (control_uart_s1_agent_rsp_fifo_out_data),                    //                .data
		.rf_source_ready         (control_uart_s1_agent_rf_source_ready),                      //       rf_source.ready
		.rf_source_valid         (control_uart_s1_agent_rf_source_valid),                      //                .valid
		.rf_source_startofpacket (control_uart_s1_agent_rf_source_startofpacket),              //                .startofpacket
		.rf_source_endofpacket   (control_uart_s1_agent_rf_source_endofpacket),                //                .endofpacket
		.rf_source_data          (control_uart_s1_agent_rf_source_data),                       //                .data
		...
		.rdata_fifo_src_ready    (control_uart_s1_agent_rdata_fifo_src_ready),                 //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (control_uart_s1_agent_rdata_fifo_src_valid),                 //                .valid
		.rdata_fifo_src_data     (control_uart_s1_agent_rdata_fifo_src_data),                  //                .data
		.m0_response             (2'b00),                                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) control_uart_s1_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                             //       clk.clk
		.reset             (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (control_uart_s1_agent_rf_source_data),                       //        in.data
		.in_valid          (control_uart_s1_agent_rf_source_valid),                      //          .valid
		.in_ready          (control_uart_s1_agent_rf_source_ready),                      //          .ready
		.in_startofpacket  (control_uart_s1_agent_rf_source_startofpacket),              //          .startofpacket
		.in_endofpacket    (control_uart_s1_agent_rf_source_endofpacket),                //          .endofpacket
		.out_data          (control_uart_s1_agent_rsp_fifo_out_data),                    //       out.data
		.out_valid         (control_uart_s1_agent_rsp_fifo_out_valid),                   //          .valid
		.out_ready         (control_uart_s1_agent_rsp_fifo_out_ready),                   //          .ready
		.out_startofpacket (control_uart_s1_agent_rsp_fifo_out_startofpacket),           //          .startofpacket
		.out_endofpacket   (control_uart_s1_agent_rsp_fifo_out_endofpacket),             //          .endofpacket
		.csr_address       (2'b00),                                                      // (terminated)
		.csr_read          (1'b0),                                                       // (terminated)
		.csr_write         (1'b0),                                                       // (terminated)
		.csr_readdata      (),                                                           // (terminated)
	...
	Qsys_mm_interconnect_0_router_002 router_017 (
		.sink_ready         (control_uart_s1_agent_rp_ready),                             //      sink.ready
		.sink_valid         (control_uart_s1_agent_rp_valid),                             //          .valid
		.sink_data          (control_uart_s1_agent_rp_data),                              //          .data
		.sink_startofpacket (control_uart_s1_agent_rp_startofpacket),                     //          .startofpacket
		.sink_endofpacket   (control_uart_s1_agent_rp_endofpacket),                       //          .endofpacket
		.clk                (clk_50_clk_clk),                                             //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                                             // in_clk_0.clk
		.in_rst_0_reset (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (control_uart_s1_agent_rdata_fifo_src_data),                  //     in_0.data
		.in_0_valid     (control_uart_s1_agent_rdata_fifo_src_valid),                 //         .valid
		.in_0_ready     (control_uart_s1_agent_rdata_fifo_src_ready),                 //         .ready
