...
The structural design of the rover system was centered around the capabilities of the Control module i.e. ESP32 board. The team took advantage of the ESP32's numerous connection interfaces to bridge all the different communication protocols used in the rover system. The ESP32 pre-processes all communications to the Command module minimise the amount of data transferred and end-to-end delay. 
...
[Module connection choices] 
\begin{itemize}
    \item Optical sensor processing on Control 
    \item Batch sensor data communication in JSON
\end{itemize}
