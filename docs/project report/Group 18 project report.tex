...
\begin{figure}[!h]
    \centering
    \subfloat[Oscilloscope output showing electrical activities]{\includegraphics[width=0.5\textwidth]{Inte_Osci1.png}}
    \hfill
    \subfloat[Oscilloscope output showing no electrical activities]{\includegraphics[width=0.5\textwidth]{Inte_Osci2.png}}
    \caption{}
\end{figure}
