...
The in Energy codebase, \textbf{the boundary between each OCV value was modified to make the range more uniform}. The algorithm always checks the value of the SOC before the start of the charging process.
